...
Safety ratings from the Gemini API may be included in the response under certain conditions (such as when content is flagged or blocked). When present, they can be accessed from the provider-specific custom metadata:
